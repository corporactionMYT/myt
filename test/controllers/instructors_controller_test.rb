...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { area_id: @instructor.area_id, document_id: @instructor.document_id, email: @instructor.email, gender: @instructor.gender, last_name: @instructor.last_name, name: @instructor.name, number_documnet: @instructor.number_documnet, online_id: @instructor.online_id, telephone: @instructor.telephone, user_id: @instructor.user_id }
    end
